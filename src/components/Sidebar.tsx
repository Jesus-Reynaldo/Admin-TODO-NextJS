  ...
  return (
    ...
    <div>
      ...
      <div className="mt-8 text-center">
        <Image src="https://tailus.io/sources/blocks/stats-cards/preview/images/second_user.webp" alt="" className="m-auto rounded-full object-cover lg:w-28 lg:h-28" width={150} height={150}/>

      ...
      <div className="flex flex-col sm:flex-row gap-2 w-full">
        ...
        <div className="flex flex-col w-full sm:w-4/12">
          <WidgetItem title="Total a pagar">
            <div className='mt-2 fle7 justify-center gap-4 items-center'>
              <h3 className='text-3xl text-center font-bold text-gray-700'>${(totalToPay*1.15).toFixed(2)}</h3>
            </div>
